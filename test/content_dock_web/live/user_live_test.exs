defmodule ContentDockWeb.UserLiveTest do
  ...
  @create_attrs %{email: "some email", first_name: "some first_name", last_name: "some last_name", login_token: "some login_token"}
  @update_attrs %{email: "some updated email", first_name: "some updated first_name", last_name: "some updated last_name", login_token: "some updated login_token"}
  @invalid_attrs %{email: nil, first_name: nil, last_name: nil, login_token: nil}
